...
{
    Task<int> GetAllCountAsync(int? Status,int? BankId,int? BranchId,int? VendorId, DateOnly? StartDate, DateOnly? EndDate, CancellationToken cancellationToken=default);
